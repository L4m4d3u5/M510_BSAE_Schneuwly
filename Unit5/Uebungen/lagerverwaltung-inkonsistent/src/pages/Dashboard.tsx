  ...
  return (
    <div style={{ padding: '24px' }}>
      ...
      <div style={{ display: 'flex', gap: '16px', marginBottom: '36px', flexWrap: 'wrap' }}>
        <StatCard variant="filled" color="#1976d2" value={gesamtArtikel} label="Artikel gesamt" />
        <StatCard variant="filled" color="#c62828" value={kritischeArtikel} label="Kritische Artikel" />
        <StatCard variant="outlined" value={`CHF ${gesamtwert.toFixed(2)}`} label="Gesamtwert Lager" valueColor="#2e7d32" labelPosition="top" />
        <StatCard variant="accent" accentColor="#ff9800" value={lagerorte} label="Lagerorte aktiv" />
      </div>
